  ...
  return (
    <div className="question-page">
      <div className="question-page-header">
        <h1>
          Find the best answer to your Bible questions, help others answer
          theirs
        </h1>
        <p>
          A community-based space to find and contribute answers to Unanswered Questions in the bible, 
